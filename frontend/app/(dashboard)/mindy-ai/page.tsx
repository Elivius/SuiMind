...
import { useMindyAgent, useTransactionManager, useGetBalances } from "@/hooks"
import {
...
export default function MindyAIPage() {
    ...
    const walletBalance = balanceQuery.data?.totalBalance ? parseFloat(balanceQuery.data.totalBalance) / 1_000_000_000 : 0
