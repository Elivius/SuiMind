    ...
    return (
        <div className="w-full px-6 py-8">
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 items-start">
                ...
                {/* Mindy AI */}
                <div className="xl:col-span-1 xl:sticky xl:top-[100px] xl:self-start transition-all duration-500 ease-in-out relative group">
                    {/* Atmospheric Background Glow */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] opacity-20 pointer-events-none">
                        <div className="absolute top-0 right-0 w-full h-full bg-[#A890FE]/20 rounded-full blur-[100px] animate-pulse" />
                        <div className="absolute bottom-0 left-0 w-3/4 h-3/4 bg-[#6FBEE5]/20 rounded-full blur-[80px]" />
                    </div>
                    ...
                    <Card className="relative border-none backdrop-blur-xl bg-[#050B15]/90 flex flex-col h-[650px] overflow-hidden shadow-2xl">
